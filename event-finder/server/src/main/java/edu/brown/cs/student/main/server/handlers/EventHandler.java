...
public class EventHandler implements Route {
  ...
  public MockEventService mockEventService;

  public EventHandler(MockEventService mockEventService) {
  ...
  public Object handle(Request request, Response response) {
    ...
    try {
      // returning mockedData as response
      return Utils.toJson(mockEventService.getEventObjects());
